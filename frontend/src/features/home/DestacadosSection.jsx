    ...
    <section className="py-16 bg-slate-50">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="text-3xl font-bold text-slate-900 font-outfit tracking-tight">Lugares Destacados</h2>
            <p className="text-slate-500 mt-2">Los mejores destinos seleccionados para ti</p>
          </div>
