      ...
      <div className="container mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to={isAuthenticated ? "/perfil" : "/login"} className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
